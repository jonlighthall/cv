...
\newcommand{\smalltimestamp}{Updated \shortusdate\today{} \currenttime{}}
...
\addtolength{\textwidth}{91.32pt}		%increase text width to 6in
\addtolength{\textheight}{104.48pt}	%increase text width to 9in
\addtolength{\hoffset}{-0.375in} %decrease left margin to 1.5in
\addtolength{\voffset}{-0.75in}  %decrease top margin to 1.0in
