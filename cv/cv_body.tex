...
%\renewcommand{\desc}[1]{}
\renewcommand{\desctext}[1]{\textrm{\small#1}}
...
\begin{itemize}
	\item Senior Postdoctoral Researcher, Department of Physics \& Astronomy, Louisiana State University\\ (C.\ Deibel), May 2016---Present
		\desc{Visiting Researcher at Florida State University.
		Principle investigator for the $^{17}$F($\alpha$,$p$) measurement using  the ANASEN detector. Establishment and maintenance of a repository for calibration and analysis code for ANASEN (C++, ROOT, Git). Development of calibration and analysis algorithms for ANASEN.
		Operated the accelerator and data acquisition for several experiments at FSU.
		Installation of the Yale split-pole spectrograph (SPS). Simulation of reactions with the SPS (FORTRAN, ROOT).}
	...
	\item Postdoctoral Research Associate, Physics Department, WMU (A.\ Wuosmaa), July 2011--October 2012 \extra{\\Started July 6, 2011; \$38,502 annually}
	  \desc{%Stationed at Argonne.
		...
		Installed and operated detectors, electronics, and data acquisition for the 
...
\item Visiting Researcher, FSU, May 2016---Present
		\desc{Supervision and collaboration of undergraduate and graduate students.}
...
\desc{Supervision and mentoring of high school students, undergraduate engineering Co-op students, and physics graduate students on %various
 projects related to EMMA commissioning.}
	...
	\extra{(postdoc from July 2011) worked with Lauren Perez summer 2012; worked with Jack Winkelbauer summer 2007, 2008; Adam Van Fall, Winter 2007, spring, summer 2008, summer 2009; Anna Woodard Fall 2008, Shadi}%
	  \desc{Supervision and mentoring of Science Undergraduate Laboratory Internship (SULI) %physics undergraduate 
	  students and physics graduate students on projects related to the commissioning and operation of HELIOS, usually working withe one student per semester.}
