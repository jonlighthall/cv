...
\graphicspath{{ltr/signatures/}{../ltr/signatures/}{../../ltr/signatures/}}
...
\newif\ifshowextras
\showextrasfalse % set to \showextrastrue to print extras in gray
\newcommand{\extra}[1]{\ifshowextras{\color{note_gray}#1}\fi}
...
\newcommand{\cvheader}[2] {%two arguments: pagestyle, right header
\clearpage
\pagestyle{#1}
\rhead{\headtext{#2}}
\phantomsection
...
\newcommand{\cvfooter}{\vspace*{1.0\baselineskip}
\sign{}
}
...
\newcommand{\cvheadersimple}[2] {%two arguments: pagestyle, right header,
\clearpage
\pagestyle{#1}
\rhead{\headtext{#2}}
\phantomsection
...
\newcommand{\cvfootersimple}{\vspace*{1.0\baselineskip}
}
...
\input{cv/cv_pubs}
\input{cv/cv_pubs_def}
\input{cv/cv_talks}
\input{cv/cv_talks_def}
}
